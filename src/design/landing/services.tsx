...
import { gradientImage, playSvg } from "@/config/imageImports";
...
export const VideoChatMessage = () => {
  return (
    <div className="absolute top-8 left-[3.125rem] w-full max-w-[14rem] bg-white  dark:bg-black pt-2.5 pr-2.5 pb-7 pl-5 bg-n-6 rounded-t-xl rounded-br-xl font-code text-base md:max-w-[17.5rem] text-black dark:text-white">
      Be Innovative
  ...
  return (
    <div className="absolute left-0 bottom-0 w-full flex items-center p-6">
      ...
      <div className={"flex-1 bg-[#D9D9D9]"}>
        <div className={"h-0.5 bg-[#ee1212] w-1/5"}></div>
      </div>
    </div>
  );
};
